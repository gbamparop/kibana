...
import { LogStacktrace } from '../components/log_stacktrace';

export const CustomLogStacktrace = ({
  filter,
  onAddColumn,
  onRemoveColumn,
  dataView,
  ...
  return (
    <>
      <EuiSpacer size="m" />
      <EuiFlexGroup direction="column">{renderCustomizedContent(flyoutContentProps)}</EuiFlexGroup>
    </>
  );
};
...
const renderContent = ({ actions, dataView, doc }: LogExplorerFlyoutContentProps) => (
  <EuiFlexItem>
    <LogStacktrace dataView={dataView} doc={doc} />
  </EuiFlexItem>
);

// eslint-disable-next-line import/no-default-export
export default CustomLogStacktrace;
